...
if ($productos != null){
    foreach ($productos as $clave => $cantidad){
        $sql = $con->prepare("SELECT ID, Nombre, Precio, Marca, Color, Talla, Stock, $cantidad as cantidad FROM Productos WHERE ID=? AND URLI=1");
        $sql->execute([$clave]);
				...
				<div class="col-md-12">
					<div class="block">
							<div class="col-md-10 order-md-8 text-left">
								<a href="Productos.php" class="btn btn-outline-secondary">Ir al catalgo</span></a>
							</div>
							</div>
	...
	<div class="container text-center">
			...
			<div class="row">
				<div class="col-md-5 offset-md-7 d-grid gap-2">
					<a href="Pago.php" class="btn-primary btn-lg">Realizar pago</a>
				</div>
			</div>
			<?php } ?>
