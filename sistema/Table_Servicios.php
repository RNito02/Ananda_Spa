...
<?php
    include ("cnn.php");
    $productos = "SELECT * FROM Servicios"
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="password.html">Registrar un nuevo usuario</a>
                                        </nav>
                                    </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                Esta tabla muestra los servicios desde la base de datos donde se podrá gestionar, analizar, eliminar, consultar y modificar todo tipo de informacionn.
                                <a target="_blank"></a>
                                .
                            </div>
                        </div>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    while($row=mysqli_fetch_assoc($resultado)){?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table__item" ><?php echo $row["Descripcion"];?></td>
                                            <td class="table__item" ><?php echo $row["Sexo"];?></td>
                                            <td class="table__item" ><?php echo $row["Cantidad_Personas"];?></td>
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <h2 class="container__tittle"></h2>
                                        <form action="insertar_servicios.php" method="POST" class="container__form">
                                            ...
                                            <label for="" class="container__label">Descripcion</label>
                                            <input  name="Descripcion" type="text" class="container__input">
                                            <br>
                                            <br>
                                            <label for="" class="container__label">Sexo</label>
                                            <input  name="Sexo" type="text" class="container__input">
                                            
                                            <label for="" class="container__label">Cantidad_Personas</label>
                                            <input  name="Cantidad_Personas" type="text" class="container__input">
                                                
                                            
                                            <label for="" class="container__label">URL</label>
                                            <input  name="URLI" type="" class="container__input">
                                            <br>
                                            <br>
