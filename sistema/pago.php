...
if ($productos != null){
    foreach ($productos as $clave => $cantidad){
        $sql = $con->prepare("SELECT ID, Nombre, Precio, $cantidad as cantidad FROM productos WHERE id=? AND URLI=1");
        $sql->execute([$clave]);
			...
			<div class="table-responsive">
                ...
                <?php } ?>
                    <div class="col-md-10 order-md-8 text-left">
						<a href="Productos.php" class="btn btn-danger">Cancelar</span></a>
					</div>
